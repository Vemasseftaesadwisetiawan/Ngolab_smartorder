  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 print:hidden">
        <div>
          <h2 className="text-2xl font-bold text-stone-900">Laporan Penjualan</h2>
          <p className="text-stone-500">Analisis performa bisnis periode {dateRangeLabels[dateRange]}</p>
        </div>
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 mb-6">
        <Card className="border-none shadow-md bg-orange-600 text-white overflow-hidden relative">
          <div className="absolute right-0 top-0 h-full w-32 bg-white/5 -skew-x-12 translate-x-16" />
          <CardContent className="pt-6 relative">
            <div className="flex items-center gap-6">
              ...
              <div>
                <p className="text-xs font-bold text-orange-100 uppercase tracking-widest mb-1">Penjualan Hari Ini</p>
                <h3 className="text-3xl font-black">Rp {(todayRevenue || 0).toLocaleString()}</h3>
                <div className="flex items-center gap-2 mt-2">
                  <Badge variant="secondary" className="bg-white/20 text-white border-none text-[10px] py-0 px-2 font-bold">
        ...
        <Card className="border-none shadow-md bg-stone-900 text-white overflow-hidden relative">
          <div className="absolute right-0 top-0 h-full w-32 bg-stone-800 -skew-x-12 translate-x-16" />
          <CardContent className="pt-6 relative">
            <div className="flex items-center gap-6">
              ...
              <div>
                <p className="text-xs font-bold text-stone-500 uppercase tracking-widest mb-1">Pendapatan Periode Ini</p>
                <h3 className="text-3xl font-black">Rp {(filteredRevenue || 0).toLocaleString()}</h3>
                <div className="flex items-center gap-2 mt-2">
                  <div className="flex items-center gap-1 text-[10px] text-green-400 font-bold bg-green-400/10 px-2 py-0.5 rounded-full">
                    <TrendingUp className="h-3 w-3" />
                    <span>Total Keseluruhan: Rp {(totalRevenue || 0).toLocaleString()}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <Card className="border-none shadow-sm bg-white hover:shadow-md transition-all">
          <CardContent className="pt-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-[10px] font-bold text-stone-500 uppercase tracking-wider mb-0.5">Pesanan Terpilih</p>
                <h3 className="text-xl font-black text-stone-900">{(filteredOrders.length || 0).toLocaleString()}</h3>
                <div className="flex items-center gap-1 mt-1">
                  <ArrowUpRight className="h-3 w-3 text-green-600" />
                  <span className="text-[10px] text-green-600 font-medium">Dari total {orders.length}</span>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="border-none shadow-sm bg-white hover:shadow-md transition-all">
          <CardContent className="pt-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-[10px] font-bold text-stone-500 uppercase tracking-wider mb-0.5">Rata-rata Transaksi</p>
                ...
                <div className="flex items-center gap-1 mt-1 text-stone-400">
                  <span className="text-[10px] font-medium">Periode {dateRangeLabels[dateRange]}</span>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="border-none shadow-sm bg-white hover:shadow-md transition-all">
          <CardContent className="pt-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-[10px] font-bold text-stone-500 uppercase tracking-wider mb-0.5">Pelanggan Baru</p>
                <h3 className="text-xl font-black text-stone-900">420</h3>
                <div className="flex items-center gap-1 mt-1">
                  <ArrowUpRight className="h-3 w-3 text-green-600" />
                  <span className="text-[10px] text-green-600 font-medium">35% Retensi</span>
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <Table>
            ...
            <TableBody>
              ...
              {filteredOrders.length === 0 && (
                <TableRow>
                  <TableCell colSpan={6} className="text-center py-10 text-stone-400">
